...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(10), math.random(self.level)))
        end
    end
    ...
    for y = 1, 8 do
        ...
        for x = 2, 8 do
            ...
            if self.tiles[y][x].color == colorToMatch then
                ...
                if matchNum >= 3 then
                    local match = {}
                    local shinyRow = false
                    -- check if matched tiles have a shiny tile
