...
gSounds = {
    ...
    ["pickup-flag"] = love.audio.newSource("sounds/pickup-key.wav", "static"),
    ["unlock-lock"] = love.audio.newSource("sounds/unlock-lock.wav", "static")
}
...
gTextures = {
    ...
    ["flags"] = love.graphics.newImage("graphics/flags2.png"),
    ["flag_cloths"] = love.graphics.newImage("graphics/flag_cloths.png")
}
...
gFrames = {
    ...
    ["flag_cloths"] = GenerateQuads(gTextures["flag_cloths"], 16, 16)
}
...
gFrames["toppersets"] =
    GenerateTileSets(gFrames["toppers"], TOPPER_SETS_WIDE, TOPPER_SETS_TALL, TILE_SET_WIDTH, TILE_SET_HEIGHT)
