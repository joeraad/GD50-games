--[[
    ...
    Entity Class is a base class for all moving objects/characters in the game.
...
function Entity:collides(entity)
    return not (self.x > entity.x + entity.width or entity.x > self.x + self.width or self.y > entity.y + entity.height or
