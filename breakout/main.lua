...
function love.load()
    ...
    gFrames = {
        ...
        ["lock"] = GenerateLockedBrick(gTextures["main"])
    }
    ...
    gSounds = {
        ...
        ["lock-hit-unlock"] = love.audio.newSource("sounds/lock-hit-unlock.wav", "static"),
...
function renderKey()
    ...
    if (gHasKey) then
        love.graphics.draw(gTextures["main"], gFrames["PowerUps"][10], keyX, keyY)
    end
end
--[[
...
-- function renderRecovery(recoverPoints)
--     love.graphics.setFont(gFonts["small"])
--     love.graphics.print("Recovery:", VIRTUAL_WIDTH - 100, 10)
--     love.graphics.printf(tostring(recoverPoints), VIRTUAL_WIDTH - 40, 10, 40, "right")
-- end
