...
--[[
    Utility function to check if table is empty
...
--[[
    ...
    sprite sheet. Since the block is on the for right and in an awkward spot.
]]
...
--[[
    ...
    manually. since they smaller than other blocks.
]]
function GenerateQuadsPowerUps(atlas)
    ...
    for i = 0, 9 do
        quads[counter] = love.graphics.newQuad(x, y, 16, 32, atlas:getDimensions())
        x = x + 16
        counter = counter + 1
    end
